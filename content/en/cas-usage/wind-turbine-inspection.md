---
title: "Wind Turbine Inspection by Drone"
...
seo:
  keywords:
    ...
    - leading edge erosion wind turbine
    - aerial wind turbine inspection
    - drone turbine maintenance
...
| Criterion | Drone inspection | Rope access (IRATA) |
|---|---|---|
| Duration per turbine | 2 to 4 hours | 2 to 5 days |
| Operator safety risk | Low | High |
| Image resolution | Centimetric | Centimetric |
| Machine downtime | Rotor only | Full shutdown |
| Relative cost | Low | High |
| Weather requirements | Wind < 8 m/s | Wind < 12 m/s |
